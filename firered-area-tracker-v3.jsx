...
const DT_TM_TIPS = {
  ...
  "Raichu":     [{move:"Thunderbolt",src:"TM24 — Game Corner, Celadon City"},{move:"Brick Break",src:"TM31 — Silph Co. 7F",oneTime:true}],
  ...
  "Arcanine":   [{move:"Flamethrower",src:"TM35 — Game Corner, Celadon City"},{move:"ExtremeSpeed",src:"Lv. 49 as Arcanine — evolve Growlithe before Lv. 49"}],
  ...
  "Electabuzz": [{move:"Thunderbolt",src:"TM24 — Game Corner, Celadon City"},{move:"Psychic",src:"TM29 — Game Corner or Route 7 (free copy)"}],
  ...
  "Aerodactyl": [{move:"Iron Tail",src:"TM23 — Silph Co.",oneTime:true},{move:"Rock Slide",src:"Move Tutor — Rock Tunnel B1F"}],
  ...
  "Hitmonchan": [{move:"Ice Punch",src:"Move Tutor"},{move:"Brick Break",src:"TM31 — Silph Co. 7F",oneTime:true}],
  ...
  "Weezing":    [{move:"Sludge Bomb",src:"TM36 — Rocket Hideout B4F",oneTime:true},{move:"Flamethrower",src:"TM35 — Game Corner, Celadon City"}],
  "Kingler":    [{move:"Ice Beam",src:"TM13 — Game Corner, Celadon City"}],
  "Dodrio":     [{move:"Aerial Ace",src:"TM40 — Route 9"}],
  "Kangaskhan": [{move:"Earthquake",src:"TM26 — Viridian Gym reward",oneTime:true},{move:"Brick Break",src:"TM31 — Silph Co. 7F",oneTime:true}],
