...
const AREAS = [
  ...
  { part:"Part 10", id:"safari-zone", name:"Safari Zone",
    ...
    pokemon:[
      {name:"Nidoran♂", method:"Grass (Center)",levels:"22",   rate:"20%",frOnly:true},
      {name:"Nidoran♀", method:"Grass (Center)",levels:"22",   rate:"20%",lgOnly:true},
      ...
      {name:"Paras",    method:"Grass (Center)",levels:"27",   rate:"5%"},
      {name:"Parasect", method:"Grass (Center)",levels:"30",   rate:"5%"},
      {name:"Tangela",  method:"Grass (Center)",levels:"22",   rate:"4%"},
      ...
      {name:"Nidorina", method:"Grass (Area 1)",levels:"28–33",rate:"10%",frOnly:true},
      {name:"Nidorino", method:"Grass (Area 1)",levels:"28–33",rate:"10%",lgOnly:true},
      {name:"Doduo",    method:"Grass (Area 1)",levels:"26",   rate:"20%"},
      {name:"Cubone",   method:"Grass (Area 1)",levels:"19",   rate:"10%"},
      {name:"Marowak",  method:"Grass (Area 1)",levels:"24",   rate:"5%"},
      {name:"Paras",    method:"Grass (Area 1)",levels:"22",   rate:"15%"},
      ...
      {name:"Paras",    method:"Grass (Area 2)",levels:"23",   rate:"15%"},
    ...
    items:[
      {name:"Nugget",       hidden:false,note:"Center — island platform (requires Surf)"},
      {name:"Leaf Stone",   hidden:true, note:"Center — island platform (★ Itemfinder, requires Surf)"},
      {name:"Max Potion",   hidden:false,note:"Center"},
      {name:"Leaf Stone",   hidden:false,note:"Area 1"},
      {name:"Full Restore", hidden:false,note:"Area 1"},
      {name:"Carbos",       hidden:false,note:"Area 1"},
      {name:"TM11 Sunny Day",hidden:false,note:"Area 1"},
      {name:"Quick Claw",   hidden:false,note:"Area 2"},
      {name:"TM47 Steel Wing",hidden:false,note:"Area 2"},
      {name:"Protein",      hidden:false,note:"Area 2"},
      {name:"Max Revive",   hidden:false,note:"Area 3"},
      {name:"Max Potion",   hidden:false,note:"Area 3"},
      {name:"TM32 Double Team",hidden:false,note:"Area 3"},
      {name:"Revive",       hidden:true, note:"Area 3 (★ Itemfinder)"},
      {name:"TM37 Sandstorm",hidden:false,note:"Area 3"},
      {name:"Gold Teeth",   hidden:false,note:"Area 3 west — return to the Safari Zone Warden in Fuchsia City for HM04 Strength"},
      {name:"HM03 Surf",    hidden:false,note:"Secret House (Area 3, far west)"},
    ],
    trainers:[] },
